...
export default function ProfessionalRegistration() {
  ...
  return (
    <>
      <SEO
        title="Criar Página Profissional | EducaDQ"
        description="Crie sua página profissional pública na plataforma EducaDQ e aumente sua visibilidade profissional."
      />
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={handleChange}
                        required
                        placeholder="Descreva sua trajetória, interesses e experiência profissional..."
                        rows={5}
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={handleChange}
                        required
                        placeholder="Ex: Conselheiro Terapeuta em Dependência Química - EducaDQ (2024)..."
                        rows={4}
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={handleChange}
                        placeholder="Adicione outros links profissionais aqui..."
                        rows={3}
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={handleChange}
                        placeholder="Adicione outras formas de contato aqui..."
                        rows={3}
                      />
                    </div>
                  </div>
