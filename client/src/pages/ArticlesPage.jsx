...
export default function ArticlesPage() {
    var _a = trpc.articles.list.useQuery(), articles = _a.data, isLoading = _a.isLoading;
    return (<>
      ...
      <section className="container max-w-6xl mx-auto px-4 py-12">
        {isLoading ? (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          </div>) : !articles || articles.length === 0 ? (<div className="text-center py-20">
            ...
            {articles.map(function (article) { return (<Link key={article.id} href={"/artigos/".concat(article.slug)}>
                <Card className="cursor-pointer hover:shadow-lg transition-shadow h-full group">
                  {article.cover && (<div className="h-48 overflow-hidden rounded-t-lg">
