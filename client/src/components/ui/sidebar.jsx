...
function Sidebar(_a) {
    var _b = _a.side, side = _b === void 0 ? "left" : _b, _c = _a.variant, variant = _c === void 0 ? "sidebar" : _c, _d = _a.collapsible, collapsible = _d === void 0 ? "offcanvas" : _d, _e = _a.disableTransition, disableTransition = _e === void 0 ? false : _e, className = _a.className, children = _a.children, props = __rest(_a, ["side", "variant", "collapsible", "disableTransition", "className", "children"]);
    var _f = useSidebar(), isMobile = _f.isMobile, state = _f.state, openMobile = _f.openMobile, setOpenMobile = _f.setOpenMobile;
    if (collapsible === "none") {
...
function SidebarTrigger(_a) {
    ...
    return (<Button data-sidebar="trigger" data-slot="sidebar-trigger" variant="ghost" size="icon" className={cn("size-7", className)} onClick={function (event) {
