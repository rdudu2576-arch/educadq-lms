...
export function ProgressPanel(_a) {
    var completedCourses = _a.completedCourses, onDownloadCertificate = _a.onDownloadCertificate;
    ...
    return (<div className="space-y-4">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {completedCourses.map(function (course) { return (<Card key={course.id} className="overflow-hidden hover:shadow-lg transition-shadow">
            {/* Course Cover */}
            <div className="relative h-40 overflow-hidden bg-gradient-to-br from-blue-500 to-purple-600">
              {course.coverUrl && (<img src={course.coverUrl} alt={course.title} className="h-full w-full object-cover"/>)}
            ...
            <CardContent className="space-y-4">
              ...
              {/* Certificate Button */}
              {course.certificateUrl && (<Button variant="outline" size="sm" className="w-full" onClick={function () { return onDownloadCertificate === null || onDownloadCertificate === void 0 ? void 0 : onDownloadCertificate(course.id); }}>
