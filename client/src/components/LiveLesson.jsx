...
export default function LiveLesson(_a) {
    var meetLink = _a.meetLink, startTime = _a.startTime, title = _a.title;
    return (<Card className="bg-slate-800 border-slate-700">
      ...
      <CardContent className="space-y-4">
        {startTime && (<div className="flex items-center gap-2 text-slate-400">
