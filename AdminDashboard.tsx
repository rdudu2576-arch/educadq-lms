...
import { Loader2, Users, BookOpen, DollarSign, AlertCircle, Plus, LogOut, Activity } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-12">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-9 bg-slate-800 border border-slate-700">
            ...
            <TabsTrigger value="monitor" className="text-white data-[state=active]:bg-red-600 data-[state=inactive]:text-white"><Activity className="w-4 h-4 mr-1" />Monitor</TabsTrigger>
          </TabsList>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-2">
                          ...
                          <Button
                            ...
                            onClick={() => setDeleteConfirm({ open: true, id: course.id })}
                          >
                            Deletar
                          </Button>
                        </div>
