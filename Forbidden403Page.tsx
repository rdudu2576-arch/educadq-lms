    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      <div className="text-center max-w-md">
        ...
        <div className="flex flex-col gap-3">
          <Button
            onClick={() => setLocation("/")}
            className="w-full bg-teal-500 hover:bg-teal-600 text-white font-semibold py-2 flex items-center justify-center gap-2"
          >
          ...
          <Button
            ...
            variant="outline"
            className="w-full border-slate-600 text-slate-300 hover:bg-slate-700 font-semibold py-2 flex items-center justify-center gap-2"
          >
        ...
        <div className="mt-8 pt-8 border-t border-slate-700">
          ...
          <div className="flex flex-col gap-2">
            <a
              href="mailto:support@educadq.com"
              className="text-teal-400 hover:text-teal-300 text-sm font-medium"
            >
              Enviar email para suporte
            </a>
            <a
              href="https://wa.me/5541988913431"
              target="_blank"
