...
import {
  Clock, BookOpen, Award, Play, CheckCircle, User,
  ArrowRight, Star, ShieldCheck, CreditCard, ArrowLeft
} from "lucide-react";
...
export default function CourseLandingPage() {
  ...
  const youtubeId = course.trailerUrl ? extractYouTubeId(course.trailerUrl) : null;
  ...
  return (
    ...
    <SEO
      title={course.title}
      description={course.description?.substring(0, 160) || `Curso ${course.title} - EducaDQ`}
      ogImage={course.coverUrl || undefined}
      ogUrl={`https://educadq-ead.com.br/curso/${course.slug}`}
    />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              {youtubeId ? (
                ...
                <div className="aspect-video rounded-xl bg-gradient-to-br from-teal-800 to-teal-600 flex items-center justify-center shadow-2xl">
