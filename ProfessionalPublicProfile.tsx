...
export default function ProfessionalPublicProfile() {
  ...
  const { data: professional, isLoading, error } = trpc.professionals.getById.useQuery(
    { id: parseInt(id || "0") },
    { enabled: !!id }
  );
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="w-full max-w-md">
          ...
          <CardContent>
            ...
            <Button onClick={() => setLocation("/profissionais")} className="w-full">
  ...
  const handleWhatsAppContact = () => {
    ...
    const message = encodeURIComponent(`Olá ${professional.publicName || "Profissional"}, gostaria de conversar com você!`);
    window.open(`https://wa.me/${phone}?text=${message}`, "_blank");
  };

  const handleEmailContact = () => {
    const email = professional.professionalEmail || professional.email;
    const subject = encodeURIComponent("Contato via EducaDQ");
    const body = encodeURIComponent(`Olá ${professional.publicName},\n\nGostaria de conversar com você sobre seus serviços.\n\nAtenciosamente`);
  ...
  return (
    <>
      <SEO
        title={`${professional.publicName} | EducaDQ`}
        description={professional.professionalBio || "Perfil profissional na plataforma EducaDQ"}
      />
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="mb-6">
                    {professional.profileImageUrl ? (
                      ...
                      <div className="w-full h-64 bg-gradient-to-br from-teal-200 to-teal-400 rounded-lg mb-4 flex items-center justify-center">
                        <span className="text-4xl font-bold text-white">
                          {professional.publicName?.charAt(0).toUpperCase()}
                        </span>
                      </div>
                    )}
                    ...
                    <div className="space-y-3 border-t border-slate-200 pt-6">
                      ...
                      {(professional.professionalEmail || professional.email) && (
                        <Button
                      ...
                      {professional.professionalPhone && professional.professionalPhone !== professional.phone && (
                        <Button
                          variant="outline"
                          className="w-full flex items-center justify-center gap-2"
                          onClick={() => window.location.href = `tel:${professional.professionalPhone}`}
                        >
                    ...
                    {/* Redes Sociais */}
                    {(professional.linkedin || professional.instagram || professional.website || professional.facebook || professional.youtube) && (
                        ...
                        <div className="flex flex-wrap gap-3">
                          {professional.linkedin && (
                            <a
                              ...
                              className="p-2 bg-slate-100 hover:bg-blue-100 rounded-lg transition"
                              title="LinkedIn"
                            >
                          ...
                          {professional.instagram && (
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="p-2 bg-slate-100 hover:bg-pink-100 rounded-lg transition"
                              title="Instagram"
                            >
                          ...
                          {professional.youtube && (
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="p-2 bg-slate-100 hover:bg-red-100 rounded-lg transition"
                              title="YouTube"
                            >
                          ...
                          {professional.website && (
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="p-2 bg-slate-100 hover:bg-teal-100 rounded-lg transition"
                              title="Website"
                            >
