...
export var materialsRouter = router({
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, db.insert(lessonMaterials).values({
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    if (!db)
                        throw new Error("Database connection failed");
                    materialId = input.materialId, data = __rest(input, ["materialId"]);
                    return [4 /*yield*/, db
