...
export var authRouter = router({
    register: publicProcedure
        ...
        role: z
            ...
            .transform(function (r) { return (r === "student" ? "user" : r); }),
        additionalData: z.any().optional(),
    }))
        .mutation(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var existing, hashedPassword, user, token;
        var _c;
        var input = _b.input, ctx = _b.ctx;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4 /*yield*/, db.getUserByEmail(input.email)];
                case 1:
                    existing = _d.sent();
                    if (existing) {
                        throw new TRPCError({
                ...
                case 2:
                    ...
                    return [4 /*yield*/, db.createUser({
                            ...
                            name: input.name,
                            role: input.role,
                            additionalData: (_c = input.additionalData) !== null && _c !== void 0 ? _c : null,
                        })];
                case 3:
                    user = _d.sent();
                    token = generateToken({
    ...
    login: publicProcedure
        ...
        .mutation(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var user, validPassword, _c, token;
        var input = _b.input, ctx = _b.ctx;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4 /*yield*/, db.getUserByEmail(input.email)];
    ...
    me: protectedProcedure.query(function (_a) {
        var ctx = _a.ctx;
        return ctx.user;
    }),
});
