...
export var protectedProcedure = t.procedure.use(requireUser);
export var adminProcedure = t.procedure.use(t.middleware(function (opts) { return __awaiter(void 0, void 0, void 0, function () {
    var ctx, next;
    return __generator(this, function (_a) {
        ctx = opts.ctx, next = opts.next;
