        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, createViteServer(__assign(__assign({}, viteConfig), { configFile: false, server: serverOptions, appType: "custom" }))];
                case 1:
                    vite = _a.sent();
...
export function serveStatic(app) {
    ...
    console.log("[Static] Serving from: ".concat(distPath));
    console.log("[Static] index exists: ".concat(fs.existsSync(indexPath)));
    if (!fs.existsSync(distPath)) {
        console.error("Build directory not found at ".concat(distPath, ". Run pnpm build first."));
    }
